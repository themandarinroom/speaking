...
export const TEXT = {
  en: {
    ...
    privacyShort: "Student recordings stay on this device. Only teacher model audio is cloud-hosted.", backHome: "Home", openStudent: "Open Student Mode", teacherHeading: "Build the practice sentence", teacherIntro: "Add one word unit at a time. Pinyin stays lowercase and has no tone marks.",
    ...
    publishHeading: "Live classroom publishing", publishHelp: "Publish the current practice and model audio to every device in this room.", publishClass: "Publish to Class", publishing: "Publishing to the class…", uploadingTeacherVoice: "Uploading Teacher Voice… {percent}%", publishSuccess: "Published successfully.", uploadFailed: "Upload failed. Please try again.", authExpired: "Teacher access expired. Sign in again and retry.", publishFailed: "Could not publish. Check your connection and teacher access.", lastPublished: "Last published: {time}",
  ...
  zh: {
    ...
    privacyShort: "学生录音只保存在这台设备上。只有老师示范录音会储存在云端。", backHome: "主页", openStudent: "打开学生模式", teacherHeading: "编辑练习句子", teacherIntro: "每行填写一个词语。拼音使用小写字母，不标声调。",
    ...
    publishHeading: "课堂即时发布", publishHelp: "把现在的练习和示范录音发布到这个班级的所有设备。", publishClass: "发布到班级", publishing: "正在发布到班级……", uploadingTeacherVoice: "正在上传老师录音……{percent}%", publishSuccess: "发布成功。", uploadFailed: "上传失败，请再试一次。", authExpired: "教师登录已过期。请重新登录后再试。", publishFailed: "无法发布，请检查网络和教师权限。", lastPublished: "上次发布：{time}",
