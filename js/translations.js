...
export const TEXT = {
  en: {
    ...
    publishHeading: "Live classroom publishing", publishHelp: "Publish the current practice and model settings to every iPad in this room.", publishClass: "Publish to Class", publishing: "Publishing to the class…", publishSuccess: "Published successfully. Student iPads will update automatically.", publishFailed: "Could not publish. Check your connection and teacher access.", lastPublished: "Last published: {time}",
  ...
  zh: {
    ...
    publishHeading: "课堂即时发布", publishHelp: "把现在的练习和示范设置发布到这个班级的所有 iPad。", publishClass: "发布到班级", publishing: "正在发布到班级……", publishSuccess: "发布成功，学生的 iPad 会自动更新。", publishFailed: "无法发布，请检查网络和教师权限。", lastPublished: "上次发布：{time}",
    ...
    enterRoom: "输入教室班级", roomCode: "班级代码", joinRoom: "进入班级", invalidRoom: "这个班级代码不在试用名单中。", waitingTeacher: "正在等待老师发布练习。", roomLabel: "班级 {room}", liveUpdate: "已收到老师发布的新练习。", connectionError: "无法连接教室，请检查网络后再试。", teacherRecordingUnavailable: "这台设备上还没有老师录音。",
