...
export const TEXT = {
  ...
  zh: {
    ...
    yearLevel: "年级", lessonTitle: "课程标题", practiceLabel: "练习标题", corePractice: "基础练习", challengePractice: "挑战练习", coreTeacherRecording: "基础练习老师录音", challengeTeacherRecording: "挑战练习老师录音", chooseYearLevel: "选择你的年级", joinYearLevel: "打开年级", defaultPracticeTitle: "中文口语练习", signedOut: "尚未登录", signedInAs: "登录账号", signInHelp: "请使用获准的教师 Google 账号登录，加载或发布年级练习。", signInGoogle: "使用 Google 登录", signOut: "退出登录", firebaseSetupNeeded: "Firebase 尚未设置完成。请先添加网页配置信息。", authFailed: "无法登录，请再试一次。", notAuthorised: "这个账号没有发布权限。", loadingYearLevel: "正在加载年级练习……", yearLevelLoaded: "已加载年级练习。", yearLevelEmpty: "这个年级还没有已发布的练习。",
