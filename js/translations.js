...
export const TEXT = {
  ...
  zh: {
    ...
    publishHeading: "课堂即时发布", publishHelp: "把现在的练习和示范设置发布到这个班级的所有 iPad。", publishClass: "发布到班级", publishing: "正在发布到班级……", publishSuccess: "发布成功。", publishFailed: "无法发布，请检查网络和教师权限。", lastPublished: "上次发布：{time}",
